...
return [
    'modules' => [
        ...
        'Lof_MarketProductDownloadable' => 1,
        'Lof_PreOrder' => 1,
        'Lof_SmtpApp' => 1,
        'Lofmp_ChatSystem' => 1,
        'Lofmp_CouponCode' => 1,
        'Lofmp_FavoriteSeller' => 1,
        'Lofmp_FeaturedProducts' => 1,
        'Lofmp_MultiShipping' => 1,
        'Lofmp_LayeredNavigation' => 1,
        'Lofmp_SplitOrder' => 1,
        'Lofmp_FlatRateShipping' => 1,
        'Lofmp_PageBuilder' => 1,
        'Lofmp_PreOrder' => 1,
        'Lofmp_ProductQuestions' => 1,
        'Lofmp_ProductShipping' => 1,
        'Lofmp_SellerRule' => 1,
        'Lofmp_SellerIdentificationApproval' => 1,
        'Lofmp_SellerMembership' => 1,
        'Lofmp_SellerMembershipLimit' => 1,
        'Lofmp_SellerBadge' => 1,
        'Lofmp_Slider' => 1,
        'Razorpay_Magento' => 1,
        'Lofmp_SplitOrderRazorpay' => 1,
        'Lofmp_TableRateShipping' => 1,
        'PayPal_Braintree' => 0,
        'PayPal_BraintreeGraphQl' => 1,
        'Lofmp_MarketplacePayment' => 1,
